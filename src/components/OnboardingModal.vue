...
const slides = [
  ...
  {
    title: '上のアイコンの意味',
    text: 'ヘッダーの各ボタン：時計マークは「承認待ち」（あなたが承認する分・相手の承認待ち・承認/拒否の履歴）、吹き出しは「チャット」（件ごとの会話・未読数バッジ）、「？」は使い方、ベルは「お知らせ」。左上の自分のアイコンからマイページ（各機能の入口）に入れます。',
    tap: 'マイページに「承認待ち・チャット・使い方」の入口があります',
  },
  {
    title: '支払いのやり取り',
