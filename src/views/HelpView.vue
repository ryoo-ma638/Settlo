...
const steps = [
  ...
  { img: 'g-friend', title: '⑧ イベントを作らずに1件だけ割り勘', body: '下の<b>「＋」→「フレンドと割り勘」</b>から相手を選び、品名・金額・立て替えた人・割り方を入れるだけです。いつものメンバーで軽く出し合うときに、旅行や飲み会の箱を作らずに記録できます。' },
];
    ...
    screens: [
      ...
      { name: 'イベント詳細', route: '', icon: 'calCheck',
        ...
        items: [
          ...
          { b: 'イベントを削除する', act: '自分の一覧から外す（相手にも通知）' },
        ] },
  ...
  },
  {
    ...
    screens: [
      { name: '元に戻す', route: '', icon: 'trash',
        purpose: '削除した立て替えの復元と、精算済みを未精算へ戻す依頼を行います。',
        items: [
